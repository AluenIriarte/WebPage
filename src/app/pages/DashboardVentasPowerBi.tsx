...
const focusPoints = [
  ...
  "Margen, mix y expansión comercial",
...
const serviceSteps = [
  {
    ...
    body: "No parto de gráficos sueltos. Parto de qué decisiones comerciales tiene que soportar el dashboard.",
  },
  {
    icon: Database,
    title: "Después ordeno la capa de datos",
    body: "Conecto fuentes, criterios y estructura para que la lectura no dependa de archivos dispersos o armado manual.",
  },
  {
    icon: BarChart3,
    title: "Y recién ahí diseño la vista",
    body: "El tablero se construye para reuniones, seguimiento y priorización, no para decorar una pantalla.",
  },
  {
    icon: ShieldCheck,
    title: "Lo dejo listo para uso real",
    body: "La entrega contempla adopción, foco de lectura y una lógica que pueda sostenerse en el tiempo.",
  },
];
            ...
            <div className="grid gap-12 lg:grid-cols-[1fr_0.92fr] lg:items-start">
              ...
              >
                ...
                <div className="space-y-5">
                  <h1 className="text-4xl font-semibold leading-[1.08] tracking-tight text-foreground md:text-5xl lg:text-[3.2rem]">
                    Dashboard de ventas y Power BI para dirección comercial
                  </h1>
                  <p className="max-w-2xl text-lg leading-relaxed text-muted-foreground">
                    Si buscás un proveedor para diseñar un dashboard comercial a medida, esta es la
                    página concreta del servicio principal.
                  </p>
                  <p className="max-w-3xl text-base leading-relaxed text-foreground/70">
                    El objetivo no es tener un tablero más. Es dejar visible qué pasa con cartera,
                    margen, metas, mix y expansión para poder decidir con más foco.
                  </p>
                </div>

                <div className="grid gap-3 sm:grid-cols-2">
                  {focusPoints.map((item) => (
                    <div key={item} className="rounded-2xl border border-border/50 bg-white px-5 py-4 text-sm font-medium text-foreground/78">
                      {item}
                    </div>
                  ))}
                </div>
                ...
                <div className="flex flex-col gap-4 sm:flex-row">
                  ...
                  <Link
                    to={buildQuotePageHref("Dashboard de ventas / BI comercial a medida")}
                    onClick={() => trackQuoteClick("primary_service_page", "Dashboard de ventas / BI comercial a medida")}
              ...
              >
                ...
                <h2 className="text-3xl font-semibold tracking-tight text-foreground">
                  Este servicio tiene sentido cuando el problema ya está en ventas, cartera o margen.
                </h2>
                <div className="mt-8 space-y-4">
                  {serviceSteps.map((step) => (
                    <div key={step.title} className="flex gap-4 rounded-2xl border border-border/40 bg-muted/20 p-4">
              ...
              <div className="grid gap-8 lg:grid-cols-[1fr_auto] lg:items-center">
                <div>
                  ...
                  <h2 className="mt-3 text-3xl font-semibold tracking-tight text-white">
                    También podés volver a la página de servicios para revisar otros productos.
                  </h2>
                </div>
                <Link
