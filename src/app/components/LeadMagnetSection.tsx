  ...
  return (
    <section id="recurso" className="relative overflow-hidden bg-[#F8F8F6] py-20 lg:py-24">
      <div className="pointer-events-none absolute inset-0 -z-10">
        <div className="absolute left-1/2 top-10 h-[360px] w-[360px] -translate-x-1/2 rounded-full bg-accent/[0.06] blur-3xl" />
      </div>
          ...
          {freeResources.map((resource) => {
            ...
            return (
              <motion.div
                ...
                className="relative min-h-[290px] sm:min-h-[250px]"
              >
                <div
                  className="absolute inset-0 overflow-hidden rounded-[2.25rem] border border-white/80 bg-white shadow-[0_28px_80px_rgba(15,23,42,0.08)]"
                  style={{ backfaceVisibility: "hidden" }}
                >
                  <div className="grid h-full gap-5 p-5 sm:grid-cols-[220px_1fr] sm:items-center sm:p-6">
                    <div className="relative overflow-hidden rounded-[1.8rem] bg-[#12192D] p-5 text-white">
                      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(139,92,246,0.32),transparent_40%),radial-gradient(circle_at_bottom_left,rgba(34,211,238,0.12),transparent_30%)]" />
                      <div className="relative flex min-h-[180px] flex-col justify-between">
                        ...
                        <div>
                          ...
                          <h3 className="mt-3 text-[1.75rem] font-semibold leading-[1.02] tracking-tight">
                            {resource.title}
                          </h3>
                        </div>
                      </div>
                ...
                >
                  <div className="grid h-full gap-5 p-5 sm:grid-cols-[220px_1fr] sm:p-6">
                    <div className="relative overflow-hidden rounded-[1.8rem] bg-[#12192D] p-5 text-white">
                      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(139,92,246,0.32),transparent_40%),radial-gradient(circle_at_bottom_left,rgba(34,211,238,0.12),transparent_30%)]" />
                      <div className="relative flex h-full flex-col justify-between">
                        ...
                        <div>
                          <h3 className="text-[1.5rem] font-semibold leading-[1.04] tracking-tight">
